...
private:
    ...
    std::vector<const char*> manualPeerOptionPtrs_;
...
public:
    ...
    static void manual_peer_get(ModContext*, void*, UiControlValue*);
    static void manual_peer_set(ModContext*, void*, const UiControlValue*);
